 describe('Profile',function(){
       ...
       beforeEach(inject(function($injector) {
        ...
        it('follows user', function() {
          ...
          // This is the user that is logged
		  scope.user = {"id":75,"email":"ekaitz7@gmail.com","created_at":"2015-09-22T12:30:55.634Z","updated_at":"2015-11-25T19:10:14.040Z","username":"ekaitz7gmail","provider":null,"uid":null,"bio":null,"skin_type":"combination","favourite_brand":null,"skin_tone":"cocoa","hash_url_image":"5de39ea38b04e82f5e19145bfe02b344bf869a38dab895e8c506b0797fa04b82_b6225b2785d9866da5e7e57e18f74c495360b073c88210e928bbef6dcff17263_1446157660","eye_color":"hazel","instagram_profile":null,"youtube_channel":null,"age":"1970-10-13T23:00:00.000Z","followers_count":0,"following_count":0};
                  $httpBackend.whenPOST('/api/relationships/').respond(200);

		  // user_id = 77 is the user that we are going to follow
        ...
        if('unfollow user',function(){
	        
	        scope.user = {"id":75,"email":"ekaitz7@gmail.com","created_at":"2015-09-22T12:30:55.634Z","updated_at":"2015-11-25T19:10:14.040Z","username":"ekaitz7gmail","provider":null,"uid":null,"bio":null,"skin_type":"combination","favourite_brand":null,"skin_tone":"cocoa","hash_url_image":"5de39ea38b04e82f5e19145bfe02b344bf869a38dab895e8c506b0797fa04b82_b6225b2785d9866da5e7e57e18f74c495360b073c88210e928bbef6dcff17263_1446157660","eye_color":"hazel","instagram_profile":null,"youtube_channel":null,"age":"1970-10-13T23:00:00.000Z","followers_count":0,"following_count":1};
                  $httpBackend.whenPOST('/api/relationships/').respond(200);

          scope.followed_id = 77; 
          scope.unfollowUser(77);
          $httpBackend.flush();
          expect(scope.user.followers_count).toBe(0);
